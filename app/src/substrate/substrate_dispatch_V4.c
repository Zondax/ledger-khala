...
{
    CHECK_ERROR(_readAccountIdLookupOfT_V4(c, &m->dest))
...
{
    CHECK_ERROR(_readAccountIdLookupOfT_V4(c, &m->source))
    CHECK_ERROR(_readAccountIdLookupOfT_V4(c, &m->dest))
    CHECK_ERROR(_readCompactBalance(c, &m->amount))
    return parser_ok;
}
...
{
    CHECK_ERROR(_readAccountIdLookupOfT_V4(c, &m->who))
...
{
    CHECK_ERROR(_readAccountIdLookupOfT_V4(c, &m->real))
...
{
    CHECK_ERROR(_readAccountIdLookupOfT_V4(c, &m->delegate))
...
{
    CHECK_ERROR(_readAccountIdLookupOfT_V4(c, &m->spawner))
    CHECK_ERROR(_readProxyType_V4(c, &m->proxy_type))
    CHECK_ERROR(_readu16(c, &m->index))
    ...
    uint8_t pageIdx, uint8_t* pageCount)
{
    ...
    case 10240: /* module 40 call 0 */
        ...
        case 0: /* balances_transfer_V4 - dest */;
            return _toStringAccountIdLookupOfT_V4(
