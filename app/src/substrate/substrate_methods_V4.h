...
#define PD_CALL_BALANCES_V4 40
#define PD_CALL_PROXY_V4 5
#define PD_CALL_SYSTEM_V4 0

#define PD_CALL_BALANCES_TRANSFER_ALL_V4 4
typedef struct {
    pd_AccountIdLookupOfT_V4_t dest;
...
typedef struct {
    pd_AccountIdLookupOfT_V4_t spawner;
    pd_ProxyType_V4_t proxy_type;
    pd_u16_t index;
...
typedef struct {
    pd_AccountIdLookupOfT_V4_t real;
...
typedef struct {
    pd_AccountIdLookupOfT_V4_t source;
    pd_AccountIdLookupOfT_V4_t dest;
    pd_CompactBalance_t amount;
